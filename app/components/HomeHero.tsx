...
export function HomeHero() {
  return (
    <section className="relative h-[550px] sm:h-[600px] md:h-[650px] lg:h-[700px] xl:h-[750px]">
      <Swiper
      ...
      >
        <SwiperSlide className="relative overflow-hidden h-full">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-24 py-16 h-full flex justify-center items-center">
            <div className="flex flex-col md:flex-row lg:flex-row justify-center items-center gap-10 lg:gap-20 text-center lg:text-left">
        ...
        <SwiperSlide className="relative overflow-hidden h-full">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-24 py-16 h-full flex justify-center items-center">
            <div className="flex flex-col md:flex-row lg:flex-row justify-center items-center gap-10 lg:gap-12 text-center lg:text-left">
